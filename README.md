...
Identifica o top 10 de **Produtos Mais Vendidos** e o top 10 de **Produtos Menos Vendidos** para cada filial. Na **Loja 3**, a margem mínima de vendas dos produtos menos vendidos é de 35 unidades, sugerindo um fluxo de vendas mais equilibrado.
...
1.  **Clone o repositório** (se estiver em um) ou baixe o arquivo `.ipynb`.
2.  Certifique-se de ter as bibliotecas **pandas**, **matplotlib** e **seaborn** instaladas em seu ambiente Python.
3.  Abra o notebook `AluraStoreBrasil (2).ipynb` em um ambiente como Google Colab ou Jupyter Notebook.
4.  Execute todas as células sequencialmente para replicar a importação de dados e as análises.
